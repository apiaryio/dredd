Feature: Hooks in JavaScript
  ...
  Background:
    ...
    And I have an implementation, which requires authorization on "POST /articles"
  ...
  Scenario: Testing with authorization
    Given I have hooks adding authorization to "POST /articles"
    When I run Dredd
    Then the "GET /articles" test passes
