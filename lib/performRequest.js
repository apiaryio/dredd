...
function performRequest(uri, transactionReq, options, callback) {
  ...
  try {
    ...
    httpOptions.cert = transactionReq.cert;
    httpOptions.key = transactionReq.key;
    httpOptions.requestCert = transactionReq.requestCert;
    httpOptions.rejectUnauthorized = transactionReq.rejectUnauthorized;
