...
export const applyAnswers = (config, answers, options = {}) => {
  const ci = options.ci || {
...
export const printClosingMessage = (config, print = console.log) => {
...
export const updateAppVeyor = (options = {}) => {
...
export const updateCircleCI = (options = {}) => {
  const edit = options.editYaml || editYaml
...
export const updateTravisCI = (options = {}) => {
  const edit = options.editYaml || editYaml
...
export const updateWercker = (options = {}) => {
  const edit = options.editYaml || editYaml
...
export const detectLanguage = (files) => {
...
export const detectServer = (files) => {
  const commands = {
    nodejs: 'npm start',
...
export const detectApiDescription = (files) => {
