...
class HooksWorkerClient {
  constructor(runner) {
    ...
    this.timeout = options['hooks-handler-timeout'] || 5000;
    this.connectTimeout = options['hooks-handler-connect-timeout'] || 1500;
    this.connectRetry = options['hooks-handler-connect-retry'] || 500;
    this.afterConnectWait = options['hooks-handler-after-connect-wait'] || 100;
    this.termTimeout = options['hooks-handler-term-timeout'] || 5000;
    this.termRetry = options['hooks-handler-term-retry'] || 500;
    this.handlerHost = options['hooks-handler-host'] || '127.0.0.1';
    this.handlerPort = options['hooks-handler-port'] || 61321;
