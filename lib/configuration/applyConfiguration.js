...
const DEFAULT_CONFIG = {
  ...
  hookfiles: [],
  language: 'nodejs',
  'hooks-handler-timeout': 5000,
  'hooks-handler-connect-timeout': 1500,
  'hooks-handler-connect-retry': 500,
  'hooks-handler-after-connect-wait': 100,
  'hooks-handler-term-timeout': 5000,
  'hooks-handler-term-retry': 500,
  'hooks-handler-host': '127.0.0.1',
  'hooks-handler-port': 61321,
};
