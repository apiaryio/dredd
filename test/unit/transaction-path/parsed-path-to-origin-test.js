...
describe('parsedPathToOrigin()', () => {
  ...
  describe('path compilation', () => {
    ...
    describe('Full notation with multiple request-response pairs', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
    ...
    describe('Full notation with multiple request-response pairs and a colon in some name', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: 'Some API Name',
          resourceGroupName: 'Some Group Name',
    ...
    describe('Full notation without group', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: 'Some API Name',
          resourceGroupName: '',
    ...
    describe('Full notation without group and API name', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: '',
          resourceGroupName: '',
    ...
    describe('Full notation without group and API name with used delimiter character', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: '',
          resourceGroupName: '',
    ...
    describe('Full notation without group and API name with used escape character without delimiter character', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: '',
          resourceGroupName: '',
    ...
    describe('Full notation without group and API name with used escape character with delimiter character', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: '',
          resourceGroupName: '',
    ...
    describe('Simplified notation', () => it('result should match the source origin', () => {
      transaction = {
        origin: {
          apiName: '',
          resourceGroupName: '',
