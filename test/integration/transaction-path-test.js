...
describe('compiled transaction paths', () => {
  describe('Full notation with multiple request-response pairs', () => it('should have expected path', (done) => {
    const code = `
# Some API Name
...
`;
  ...
  describe('Full notation without group', () => it('should have expected path', (done) => {
    const code = `
# Some API Name
...
`;
  ...
  describe('Full notation without group and API name', () => it('should have expected path', (done) => {
    const code = `
### Some Resource Name [/resource]
...
`;
  ...
  describe('Full notation without group and API name with a colon', () => it('should have expected path', (done) => {
    const code = `
# My API: Revamp
...
`;
  ...
  describe('simplified notation', () => it('should have expected path', (done) => {
    const code = `\
# GET /message
