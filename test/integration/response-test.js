...
[{
  ...
  describe(`Specifying neither response body nor schema in the ${apiDescription.name}`, function() {
    describe('when the server returns non-empty responses', function() {
    ...
    return describe('when the server returns empty responses', function() {
      let runtimeInfo = undefined;
...
[{
  ...
  describe(`Specifying no response body in the ${apiDescription.name}, but specifying a schema`, function() {
    describe('when the server returns a response not valid according to the schema', function() {
      let runtimeInfo = undefined;
    ...
    return describe('when the server returns a response valid according to the schema', function() {
      let runtimeInfo = undefined;
...
[{
  ...
  describe(`Specifying no response body in the ${apiDescription.name} and having hooks ensuring empty response`, function() {
    describe('when the server returns a non-empty responses', function() {
      let runtimeInfo = undefined;
    ...
    return describe('when the server returns an empty responses', function() {
      let runtimeInfo = undefined;
...
[{
  ...
  describe(`Working with HTTP 204 and 205 responses in the ${apiDescription.name}`, function() {
    describe('when the actual response is non-empty', function() {
      let runtimeInfo = undefined;
    ...
    return describe('when the actual response is empty', function() {
      let runtimeInfo = undefined;
