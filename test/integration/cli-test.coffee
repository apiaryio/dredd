...
describe "Command line interface", () ->
  ...
  describe 'when not node.js hooks language', () ->
    ...
    describe "Using workaround for hooks in ruby", () ->
      ...
      before (done) ->
        cmd = "export TEST_DREDD_WORKER=true; ./bin/dredd ./test/fixtures/single-get.apib http://localhost:#{PORT} --no-color --language ruby --hookfiles='./test/fixtures/ruby-hooks/hookfile*.rb'"
